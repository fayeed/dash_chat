...
- `scrollToBottomBackgroundColor` (Color) - The background color for the scroll to bottom widget, default to primary color.
- `scrollToBottomTextColor` (Color) - The text color for the  scroll to bottom widget, default to white.
